var friendStats = {
	...
	*/
	...
	main: function(myNetwork) {
		var self = this;

		fbController.getAllFriends().then(function(friends) {
			console.log("friends.length: " + friends.length);
			self.showFriendData(friends.length);
		});
	},

	showFriendData : function(myNetwork) {
		var self = this;
